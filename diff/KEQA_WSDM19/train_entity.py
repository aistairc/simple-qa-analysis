...
for line in open(os.path.join(args.map2id_dir, 'entity2id.txt'), 'r'):
...
entities_emb = np.fromfile(args.entity_emb, dtype=np.float32).reshape((len(mid_dic), args.embed_dim))
mid_emb_list = []
mids_list = []
